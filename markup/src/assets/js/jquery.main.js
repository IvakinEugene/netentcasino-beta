...
function initMagnificPopup() {
	$('.lightbox-opener').magnificPopup({
		...
		callbacks: {
			...
			// },
			change: function() {
				// if (this.content.is('#casino-summary-popup') && (this.content.find('.btn-tc'))) {
				// 	var popup = this.content,
				// 		switcher1 = popup.find('.btn-tc'),
				// 		switcher2 = popup.find('.default-popup [class*="close"]'),
				// 		switchClass = 'switch';

				// 	switcher1.on('click', function(e){
				// 		e.preventDefault();
				// 		popup.toggleClass(switchClass);
				// 	});

				// 	switcher2.each(function(){
